...
void Pthread_mutex_trylock(pthread_mutex_t *mutex) {
	...
	if ((rc = pthread_mutex_trylock(mutex)) != 0)
		posix_error(rc, "Pthread_mutex_trylock");
}
...
/******************************************
 * Wrappers for Pthread condition variables
 ******************************************/
...
void Pthread_cond_broadcast(pthread_cond_t *cond) {
	...
	if ((rc = pthread_cond_broadcast(cond)) != 0)
		posix_error(rc, "Pthread_cond_broadcast");
}

/*******************************
 * Wrappers for Pthread barriers
 *******************************/

// void Pthread_barrier_init(pthread_barrier_t *barrier, const
// 	pthread_barrierattr_t *attr, unsigned count) {
// 	int rc;
//
// 	if ((rc = pthread_barrier_init(barrier, attr, count)) != 0)
// 		posix_error(rc, "Pthread_barrier_init");
// }
//
...
// 		posix_error(rc, "Pthread_barrier_wait");
// }
